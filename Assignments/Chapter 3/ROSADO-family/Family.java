...
public class Family
{
    ...
    {   
        ...
        {
            System.out.println("Error! There is no child present, please have a child.");
        }
     ...
     */
    public void haveChild (String firstName, String middleName) // Mutator method
    {
        Person baby = new Person (firstName, middleName, false);
    ...
    public void printChild() // Mutator method
    {
        if (child != null) 
        {
            System.out.println ("The " + surname + " family " + child.getParentString() + " is: " + child.getFirstName() + " , " 
            + child.getMiddleName() + " , " + child.getAge());
        }
        else
        {
